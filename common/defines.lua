...
NDiplomacy = {
	...
	CELESTIAL_EMPIRE_REFORM_COST = 101,				-- Mandate cost of enacting a new reform for the Emperor of China.
	CELESTIAL_EMPIRE_REFORM_STABILITY_COST = 1,		-- Stability cost of enacting a new reform for the Emperor of China
	CELESTIAL_EMPIRE_REFORM_MIN_VALUE = 101,		-- Minimum value of Mandate above which new reforms can be enacted.
	...
	GREAT_POWER_SUBJECT_CONTRIBUTION = 0.2,			-- Share of subjects' development that will count towards overlord's Great Power score.
...
NCountry = {
	...
	PS_ESTABLISH_SIBERIAN_FRONTIER = 40,
